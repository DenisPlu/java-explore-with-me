...
public class BaseClient {
    ...
    protected <T> ResponseEntity<Object> delete(String path, Long userId, @Nullable Map<String, Object> parameters, T body) {
        return makeAndSendRequest(HttpMethod.DELETE, path, userId, parameters, body);
    }
